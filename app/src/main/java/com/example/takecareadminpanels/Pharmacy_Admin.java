...
public class Pharmacy_Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient (new Pharmacy_Admin.callBack ( ));

        webView.loadUrl ("http://takecaresystem.pythonanywhere.com/Phy_Login/");
    }
