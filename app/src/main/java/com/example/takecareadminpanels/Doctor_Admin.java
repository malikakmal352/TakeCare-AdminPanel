...
public class Doctor_Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient (new Doctor_Admin.callBack ( ));

        webView.loadUrl ("http://takecaresystem.pythonanywhere.com/Doctor_admin/");
    }
