...
public class Doctor_Request_Form extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_doctor_request_form);
        ...
        webView.setWebViewClient (new Doctor_Request_Form.callBack ( ));

        webView.loadUrl ("http://takecaresystem.pythonanywhere.com/Doctor_request_form/");
    }
